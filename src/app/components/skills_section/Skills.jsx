      ...
      <>
        <div className="px-5 max-w-[1560px] mx-auto mt-10 py-10">
          ...
          <div className="flex flex-wrap items-center justify-between gap-10 text-white ">
            ...
            {/* right & mapping */}
            <div className="flex flex-wrap justify-around w-10/12 gap-4 mx-auto  md:justify-end md:w-1/2">
              {skills.map(({title, languages}, index) => {
                return (
                    <div key={`skills-${index}`} className="w-[90%] sm:w-[45%] lg:w-[30%] border border-[#ABB2BF]">
                      <div className="p-2 ">
